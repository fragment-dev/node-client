...
export type CreateCustomCurrencyResponse =
  | BadRequestError
...
export type CreateLedgerAccountsResponse =
  | BadRequestError
...
export type DeleteCustomTxsResponse =
  | BadRequestError
...
export type MigrateLedgerEntryResponse =
  | BadRequestError
  | InternalError
...
export type ReconcileTxResponse =
  | BadRequestError
  | InternalError
  | ReconcileTxResult;
...
export type SyncCustomAccountsResponse =
  | BadRequestError
  | InternalError
...
export type SyncCustomTxsResponse =
  | BadRequestError
  | InternalError
  | SyncCustomTxsResult;
...
export type UpdateLedgerMutation = {
  ...
  updateLedger:
    ...
    | {
        __typename: "UpdateLedgerResult";
        ledger: { __typename: "Ledger"; id: string; ik: string; name: string };
      };
};
...
export type GetEntriesToMigrateForLedgerEntryDataMigrationQueryVariables =
  Exact<{
    ledgerIk: string;
    entryType: string;
    typeVersion: string;
...
export type GetEntriesToMigrateForLedgerAccountDataMigrationQueryVariables =
  Exact<{
    ledgerIk: string;
    accountPath: string;
    after?: string | null | undefined;
...
export function getSdk(
  ...
  return {
    storeSchema(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<StoreSchemaMutation>({
    ...
    reconcileTx(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ReconcileTxMutation>({
    ...
    getWorkspace(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetWorkspaceQuery>({
    ...
    getEntryDataMigrations(
      variables: GetEntryDataMigrationsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"],
    ): Promise<GetEntryDataMigrationsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetEntryDataMigrationsQuery>({
    ...
    getEntriesToMigrateForLedgerEntryDataMigration(
      variables: GetEntriesToMigrateForLedgerEntryDataMigrationQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"],
    ): Promise<GetEntriesToMigrateForLedgerEntryDataMigrationQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetEntriesToMigrateForLedgerEntryDataMigrationQuery>({
    ...
    getAccountDataMigrations(
      variables: GetAccountDataMigrationsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"],
    ): Promise<GetAccountDataMigrationsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAccountDataMigrationsQuery>({
    ...
    getEntriesToMigrateForLedgerAccountDataMigration(
      variables: GetEntriesToMigrateForLedgerAccountDataMigrationQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"],
    ): Promise<GetEntriesToMigrateForLedgerAccountDataMigrationQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetEntriesToMigrateForLedgerAccountDataMigrationQuery>(
            {
              document:
                GetEntriesToMigrateForLedgerAccountDataMigrationDocument,
              variables,
              requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
              signal,
            },
    ...
    createCustomCurrency(
      variables: CreateCustomCurrencyMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"],
    ): Promise<CreateCustomCurrencyMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateCustomCurrencyMutation>({
