...
export function getSdk(
  ...
  return {
    storeSchema(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<StoreSchemaMutation>(StoreSchemaDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "storeSchema",
    ...
    addLedgerEntries(
      variables: AddLedgerEntriesMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<AddLedgerEntriesMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AddLedgerEntriesMutation>(
            AddLedgerEntriesDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "addLedgerEntries",
    ...
    reconcileTx(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ReconcileTxMutation>(ReconcileTxDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "reconcileTx",
    ...
    getLedger(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetLedgerQuery>(GetLedgerDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "getLedger",
    ...
    getWorkspace(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetWorkspaceQuery>(GetWorkspaceDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "getWorkspace",
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetEntryDataMigrationsQuery>(
            GetEntryDataMigrationsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getEntryDataMigrations",
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetEntriesToMigrateForLedgerEntryDataMigrationQuery>(
            GetEntriesToMigrateForLedgerEntryDataMigrationDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getEntriesToMigrateForLedgerEntryDataMigration",
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAccountDataMigrationsQuery>(
            GetAccountDataMigrationsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "getAccountDataMigrations",
