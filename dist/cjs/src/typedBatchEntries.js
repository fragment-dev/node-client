...
exports.generateTypedEntryPayloads = exports.renderTypedEntryPayloads = exports.renderVariableType = exports.collectScalarNames = exports.nameTypedEntryPayloads = exports.deriveTypedEntryPayloads = void 0;
/**
...
exports.renderVariableType = renderVariableType;
...
const renderField = (field, scalars) => {
    ...
    const docs = FIELD_DOCS[field.name]
        ...
        : "";
    return `${docs}  ${renderPropertyKey(field.name)}${optional}: ${(0, exports.renderVariableType)(field.type, scalars)}${undefinable};`;
};
const renderParameters = (payload, scalars) => {
    ...
    if (payload.parametersMode === "untyped") {
        const type = payload.parametersType
            ? (0, exports.renderVariableType)(payload.parametersType, scalars)
            : "Scalars['JSON']['input']";
    ...
    const fields = payload.parameters.map((parameter) => {
        ...
        return `    ${renderPropertyKey(parameter.wireName)}${optional}: ${(0, exports.renderVariableType)(parameter.type, scalars)}${undefinable};`;
    });
...
const renderPayload = (payload, scalars) => {
    ...
    const ikType = payload.ikType
        ? (0, exports.renderVariableType)(payload.ikType, scalars)
