...
export type CreatePaymentResponse = BadRequestError | CreatePaymentResult | InternalError;
...
export type InstantiateLedgerAccountResponse = BadRequestError | InstantiateLedgerAccountResult | InternalError;
...
export type PaymentEventsConnection = {
    ...
    /** The current page of results. */
    nodes: Array<PaymentCardCapturedEvent | PaymentCheckoutCompletedEvent | PaymentCreatedEvent | PaymentSettledEvent>;
...
export type ReverseLedgerEntryResponse = BadRequestError | InternalError | ReverseLedgerEntryResult;
...
export declare enum SchemaLedgerAccountStatus {
...
export declare enum SchemaPaymentAccountingEventKey {
...
export declare enum SchemaPaymentTypeDirection {
 ...
 */
export declare enum SchemaSystemLineKind {
...
export type AddLedgerEntryMutationVariables = Exact<{
    ...
    ledgerIk: string;
    type: string;
    typeVersion?: number | null | undefined;
    posted?: string | null | undefined;
    parameters: Record<string, unknown>;
    tags?: Array<LedgerEntryTagInput> | LedgerEntryTagInput | null | undefined;
    groups?: Array<LedgerEntryGroupInput> | LedgerEntryGroupInput | null | undefined;
}>;
...
export type ListLedgerAccountBalancesQueryVariables = Exact<{
    ...
    first?: number | null | undefined;
    before?: string | null | undefined;
    balanceCurrency?: CurrencyMatchInput | null | undefined;
    balanceAt?: string | null | undefined;
    ownBalanceConsistencyMode?: ReadBalanceConsistencyMode | null | undefined;
}>;
...
export type ListMultiCurrencyLedgerAccountBalancesQueryVariables = Exact<{
    ...
    before?: string | null | undefined;
    balanceAt?: string | null | undefined;
    ownBalancesConsistencyMode?: ReadBalanceConsistencyMode | null | undefined;
}>;
...
export type GetLedgerAccountLinesQueryVariables = Exact<{
    ...
    first?: number | null | undefined;
    before?: string | null | undefined;
    filter?: LedgerLinesFilterSet | null | undefined;
}>;
...
export type ListLedgerEntriesQueryVariables = Exact<{
    ...
    first?: number | null | undefined;
    before?: string | null | undefined;
    filter?: LedgerEntriesFilterSet | null | undefined;
}>;
...
export type ListLedgerEntryGroupBalancesQueryVariables = Exact<{
    ...
    groupKey: string;
    groupValue: string;
    consistencyMode?: ReadBalanceConsistencyMode | null | undefined;
    after?: string | null | undefined;
    before?: string | null | undefined;
    first?: number | null | undefined;
    last?: number | null | undefined;
    filter?: LedgerEntryGroupBalanceFilterSet | null | undefined;
}>;
...
export type GetEntryDataMigrationsQueryVariables = Exact<{
    ledgerIk: string;
    filter?: LedgerEntryDataMigrationsFilterSet | null | undefined;
    after?: string | null | undefined;
    before?: string | null | undefined;
    first?: number | null | undefined;
    last?: number | null | undefined;
...
export type GetAccountDataMigrationsQueryVariables = Exact<{
    ledgerIk: string;
    filter?: LedgerAccountDataMigrationsFilterSet | null | undefined;
    after?: string | null | undefined;
    before?: string | null | undefined;
    first?: number | null | undefined;
    last?: number | null | undefined;
...
export declare const DeleteCustomTxsDocument: import("graphql").DocumentNode;
...
export declare function getSdk(client: GraphQLClient, withWrapper?: SdkFunctionWrapper): {
    storeSchema(variables: StoreSchemaMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<StoreSchemaMutation>;
    deleteSchema(variables: DeleteSchemaMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<DeleteSchemaMutation>;
    createLedger(variables: CreateLedgerMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<CreateLedgerMutation>;
    deleteLedger(variables: DeleteLedgerMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<DeleteLedgerMutation>;
    addLedgerEntry(variables: AddLedgerEntryMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<AddLedgerEntryMutation>;
    reverseLedgerEntry(variables: ReverseLedgerEntryMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<ReverseLedgerEntryMutation>;
    migrateLedgerEntry(variables: MigrateLedgerEntryMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<MigrateLedgerEntryMutation>;
    addLedgerEntryRuntime(variables: AddLedgerEntryRuntimeMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<AddLedgerEntryRuntimeMutation>;
    reconcileTx(variables: ReconcileTxMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<ReconcileTxMutation>;
    reconcileTxRuntime(variables: ReconcileTxRuntimeMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<ReconcileTxRuntimeMutation>;
    updateLedgerEntry(variables: UpdateLedgerEntryMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<UpdateLedgerEntryMutation>;
    updateLedger(variables: UpdateLedgerMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<UpdateLedgerMutation>;
    createCustomLink(variables: CreateCustomLinkMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<CreateCustomLinkMutation>;
    syncCustomAccounts(variables: SyncCustomAccountsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<SyncCustomAccountsMutation>;
    syncCustomTxs(variables: SyncCustomTxsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<SyncCustomTxsMutation>;
    deleteCustomTxs(variables: DeleteCustomTxsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<DeleteCustomTxsMutation>;
    getLedger(variables: GetLedgerQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<GetLedgerQuery>;
    getLedgerEntry(variables: GetLedgerEntryQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<GetLedgerEntryQuery>;
    listLedgerAccounts(variables: ListLedgerAccountsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<ListLedgerAccountsQuery>;
    listLedgerAccountBalances(variables: ListLedgerAccountBalancesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<ListLedgerAccountBalancesQuery>;
    listMultiCurrencyLedgerAccountBalances(variables: ListMultiCurrencyLedgerAccountBalancesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<ListMultiCurrencyLedgerAccountBalancesQuery>;
    getLedgerAccountLines(variables: GetLedgerAccountLinesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<GetLedgerAccountLinesQuery>;
    getLedgerAccountBalance(variables: GetLedgerAccountBalanceQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<GetLedgerAccountBalanceQuery>;
    GetLedgerAccountBalanceWithChildRollup(variables: GetLedgerAccountBalanceWithChildRollupQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<GetLedgerAccountBalanceWithChildRollupQuery>;
    getSchema(variables: GetSchemaQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<GetSchemaQuery>;
    listLedgerEntries(variables: ListLedgerEntriesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<ListLedgerEntriesQuery>;
    ...
    listLedgerEntryGroupBalances(variables: ListLedgerEntryGroupBalancesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<ListLedgerEntryGroupBalancesQuery>;
    getEntryDataMigrations(variables: GetEntryDataMigrationsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<GetEntryDataMigrationsQuery>;
    getEntriesToMigrateForLedgerEntryDataMigration(variables: GetEntriesToMigrateForLedgerEntryDataMigrationQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<GetEntriesToMigrateForLedgerEntryDataMigrationQuery>;
    getAccountDataMigrations(variables: GetAccountDataMigrationsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<GetAccountDataMigrationsQuery>;
    getEntriesToMigrateForLedgerAccountDataMigration(variables: GetEntriesToMigrateForLedgerAccountDataMigrationQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<GetEntriesToMigrateForLedgerAccountDataMigrationQuery>;
    createCustomCurrency(variables: CreateCustomCurrencyMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit["signal"]): Promise<CreateCustomCurrencyMutation>;
};
