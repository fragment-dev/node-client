...
export const orderPlacedV1 = (
  ...
  buildTypedLedgerEntry('order_placed', 1, [['ledgerIk', 'ledger', 'ik'], ['posted', 'posted']], ['user_id', 'order_id', 'order_cost', 'currency', 'platform_fee', 'driver_fee', 'restaurant_id', 'driver_id'], input);
...
export const orderPlacedV2 = (
  ...
  buildTypedLedgerEntry('order_placed', 2, [['ledgerIk', 'ledger', 'ik'], ['posted', 'posted']], ['user_id', 'order_id', 'order_cost', 'currency', 'platform_fee', 'service_fee', 'driver_fee', 'restaurant_id', 'driver_id'], input);
...
export const cardSettleV1 = (
  ...
  buildTypedLedgerEntry('card_settle', 1, [['ledgerIk', 'ledger', 'ik'], ['posted', 'posted']], ['user_id', 'order_id', 'currency', 'amount'], input);
...
export const restaurantPayoutInitiateV1 = (
  ...
  buildTypedLedgerEntry('restaurant_payout_initiate', 1, [['ledgerIk', 'ledger', 'ik'], ['posted', 'posted']], ['restaurant_id', 'order_id', 'currency', 'amount', 'payout_id'], input);
...
export const restaurantPayoutSettleV1 = (
  ...
  buildTypedLedgerEntry('restaurant_payout_settle', 1, [['ledgerIk', 'ledger', 'ik'], ['posted', 'posted']], ['restaurant_id', 'payout_id', 'currency', 'amount'], input);
...
export const driverPayoutInitiateV1 = (
  ...
  buildTypedLedgerEntry('driver_payout_initiate', 1, [['ledgerIk', 'ledger', 'ik'], ['posted', 'posted']], ['driver_id', 'order_id', 'currency', 'amount', 'payout_id'], input);
...
export const driverPayoutSettleV1 = (
  ...
  buildTypedLedgerEntry('driver_payout_settle', 1, [['ledgerIk', 'ledger', 'ik'], ['posted', 'posted']], ['driver_id', 'payout_id', 'currency', 'amount'], input);
...
export const disputePayoutInitiateV1 = (
  ...
  buildTypedLedgerEntry('dispute_payout_initiate', 1, [['ledgerIk', 'ledger', 'ik'], ['posted', 'posted']], ['user_id', 'disputes_id', 'amount', 'currency', 'payout_id', 'order_id'], input);
...
export const disputePayoutSettleV1 = (
  ...
  buildTypedLedgerEntry('dispute_payout_settle', 1, [['ledgerIk', 'ledger', 'ik'], ['posted', 'posted']], ['user_id', 'disputes_id', 'amount', 'currency', 'order_id'], input);
