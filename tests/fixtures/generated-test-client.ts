...
export type Scalars = {
  ...
  FirstMoment: { input: unknown; output: unknown; }
  ...
  Parameters: { input: unknown; output: unknown; }
  ...
  PeriodFilter: { input: unknown; output: unknown; }
...
export type PostUserFundsAccountMutation = { __typename: 'Mutation', addLedgerEntry:
    | { __typename: 'AddLedgerEntryResult', isIkReplay: boolean, entry: { __typename: 'LedgerEntry', ik: string, id: string, created: string, type: string | null, posted: string, description: string | null, ledger: { __typename: 'Ledger', ik: string }, tags: Array<{ __typename: 'LedgerEntryTag', key: string, value: string }>, groups: Array<{ __typename: 'LedgerEntryGroup', key: string, value: string }> }, lines: Array<{ __typename: 'LedgerLine', amount: string, key: string | null, account: { __typename: 'LedgerAccount', path: string }, currency: { __typename: 'Currency', code: CurrencyCode, customCurrencyId: string | null } | null }> }
...
export type PostUserFundsAccount_V2Mutation = { __typename: 'Mutation', addLedgerEntry:
    | { __typename: 'AddLedgerEntryResult', isIkReplay: boolean, entry: { __typename: 'LedgerEntry', ik: string, id: string, created: string, type: string | null, posted: string, description: string | null, ledger: { __typename: 'Ledger', ik: string }, tags: Array<{ __typename: 'LedgerEntryTag', key: string, value: string }>, groups: Array<{ __typename: 'LedgerEntryGroup', key: string, value: string }> }, lines: Array<{ __typename: 'LedgerLine', amount: string, key: string | null, account: { __typename: 'LedgerAccount', path: string }, currency: { __typename: 'Currency', code: CurrencyCode, customCurrencyId: string | null } | null }> }
    | { __typename: 'BadRequestError', code: string, message: string, retryable: boolean }
    | { __typename: 'InternalError', code: string, message: string, retryable: boolean }
   };
...
export type PostFundingSettlementMutation = { __typename: 'Mutation', addLedgerEntry:
    | { __typename: 'AddLedgerEntryResult', isIkReplay: boolean, entry: { __typename: 'LedgerEntry', ik: string, id: string, created: string, type: string | null, posted: string, description: string | null, ledger: { __typename: 'Ledger', ik: string }, tags: Array<{ __typename: 'LedgerEntryTag', key: string, value: string }>, groups: Array<{ __typename: 'LedgerEntryGroup', key: string, value: string }> }, lines: Array<{ __typename: 'LedgerLine', amount: string, key: string | null, account: { __typename: 'LedgerAccount', path: string }, currency: { __typename: 'Currency', code: CurrencyCode, customCurrencyId: string | null } | null }> }
    | { __typename: 'BadRequestError', code: string, message: string, retryable: boolean }
    | { __typename: 'InternalError', code: string, message: string, retryable: boolean }
   };
...
export type PostPaymentProcessingMutation = { __typename: 'Mutation', addLedgerEntry:
    | { __typename: 'AddLedgerEntryResult', isIkReplay: boolean, entry: { __typename: 'LedgerEntry', ik: string, id: string, created: string, type: string | null, posted: string, description: string | null, ledger: { __typename: 'Ledger', ik: string }, tags: Array<{ __typename: 'LedgerEntryTag', key: string, value: string }>, groups: Array<{ __typename: 'LedgerEntryGroup', key: string, value: string }> }, lines: Array<{ __typename: 'LedgerLine', amount: string, key: string | null, account: { __typename: 'LedgerAccount', path: string }, currency: { __typename: 'Currency', code: CurrencyCode, customCurrencyId: string | null } | null }> }
    | { __typename: 'BadRequestError', code: string, message: string, retryable: boolean }
    | { __typename: 'InternalError', code: string, message: string, retryable: boolean }
   };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    PostUserFundsAccount(variables: PostUserFundsAccountMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<PostUserFundsAccountMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<PostUserFundsAccountMutation>({ document: PostUserFundsAccountDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'PostUserFundsAccount', 'mutation', variables);
    },
    PostUserFundsAccount_v2(variables: PostUserFundsAccount_V2MutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<PostUserFundsAccount_V2Mutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<PostUserFundsAccount_V2Mutation>({ document: PostUserFundsAccount_V2Document, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'PostUserFundsAccount_v2', 'mutation', variables);
    },
    PostFundingSettlement(variables: PostFundingSettlementMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<PostFundingSettlementMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<PostFundingSettlementMutation>({ document: PostFundingSettlementDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'PostFundingSettlement', 'mutation', variables);
    },
    PostPaymentProcessing(variables: PostPaymentProcessingMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<PostPaymentProcessingMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<PostPaymentProcessingMutation>({ document: PostPaymentProcessingDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'PostPaymentProcessing', 'mutation', variables);
    }
  };
}
